...
from yacs.config import CfgNode as CN #这种包的导入方式是约定俗成的，需要创建CN()这个作为容器来装载我们的参数
#yacs就是一个为项目构建config文件的库，一个代码可读性强的项目，最好都有yacs
...
_C.MODEL = CN() #嵌套使用，MODEL就相当于一个容器了，可以装一下参数了
...
_C.SOLVER.SOFTENING_FACTOR = 10.0
_C.SOLVER.SCALING_FACTOR = 1.0
